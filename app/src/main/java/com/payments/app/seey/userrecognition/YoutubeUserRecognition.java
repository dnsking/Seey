...
public class YoutubeUserRecognition extends AppUserRecognition{
    public YoutubeUserRecognition(Context context, String app) {
        super(context,app);
    }
    ...
    public String findUser(Bitmap screenshotColor) {
        ...
        int top = screenshotColor.getHeight()/3;
        int section = screenshotColor.getHeight()-top;
